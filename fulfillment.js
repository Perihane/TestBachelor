...
app.post('/', express.json(), (req, res) => {
  ...
  function welcome(agent){
    agent.add("Hello Hello! I am ScheduleBuddy, Dr. Ayman's virtual assistant, if you wish to schedule an appointment, please provide me with your Name, GUC ID and GUC email :) \n If you already have an appointment, and would like to cancel or modify, please say so")
